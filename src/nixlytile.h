...
extern struct wl_event_source *game_fullscreen_timer;
...
extern Client *game_fullscreen_pending_client;
...
int game_fullscreen_timer_cb(void *data);
void schedule_delayed_game_fullscreen(Client *c, uint32_t ms);
